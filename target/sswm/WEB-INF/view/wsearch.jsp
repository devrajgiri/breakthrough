							...
							<form action="${pageContext.request.contextPath}/item" class="serach-form-area" method="GET">
								<div class="row justify-content-center form-wrap">
									<div class="col-lg-4 form-cols">
										<input type="text" class="form-control" name="item" placeholder="what are you looking for? Eg. Shoes">
									</div>
					...
					<div class="row justify-content-center d-flex">
						...
						<c:forEach var="tempCustomer" items="${local}">
							...
							<div class="single-post d-flex flex-row">
								<div class="thumb">
									<img src="${pageContext.request.contextPath}/resources/img/deg.jpg" 
									height=100 width=100 alt="">
								</div>
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="single.html"><h4>${tempCustomer.workerName}</h4></a>
						...
						<div class="col-lg-4 sidebar">
							...
							<div class="single-slidebar">
								...
								<div class="active-relatedjob-carusel">
									<div class="single-rated">
										<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/r1.jpg" alt="">
							...
							<div class="single-slidebar">
								...
								<div class="blog-list">
									<div class="single-blog " style="background:#000 url(${pageContext.request.contextPath}/resources/img/blog1.jpg);">
									...
									<div class="single-blog " style="background:#000 url(${pageContext.request.contextPath}/resources/img/blog2.jpg);">
										<a href="#"><h4>Home Audio Recording <br>
										For Everyone</h4></a>
										<div class="meta justify-content-between d-flex">
											<p>
