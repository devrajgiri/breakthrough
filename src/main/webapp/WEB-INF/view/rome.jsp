					...
					<div class="row" >
						<div class="col-lg-6" style="padding:3px;">
							<div class="submit-left" >
								<h3>I Have Business</h3>
								<p>
									Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.
								</p>
								<a href="${pageContext.request.contextPath}/leaders" class="primary-btn header-btn">Submit Details</a> 
						...
						<div class="col-lg-6 " style="padding:3px;">
							<div class="submit-right">
								...
								<a href="${pageContext.request.contextPath}/systems" class="primary-btn header-btn">Submit Details</a>		
							</div>			
							</div>
					</div>
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
						<div class="col-lg-3 feat-img no-padding">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/pages/f1.jpg" alt="">
						</div>
						...
						<div class="col-lg-3 feat-img no-padding">
							<img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/pages/f2.jpg" alt="">							
						</div>
